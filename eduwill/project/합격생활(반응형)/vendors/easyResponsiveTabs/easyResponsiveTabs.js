	...
	$.fn.extend({
		easyResponsiveTabs: function (options) {
			...
			this.each(function () {
				...
				$respTabs.find('.resp-tabs-container.' + options.tabidentify + ' > div.holder').addClass('resp-tab-content').addClass(options.tabidentify);
				...
				$respTabs.find("[role=tab]").each(function () {
					...
					$currentTab.click(function () {
						...
						if (!$currentTab.hasClass('resp-tab-active') && $currentTab.hasClass('resp-accordion')) {
							...
							// Insert Notice Title
							//$respTabs.find('.resp-tab-content[aria-labelledby = ' + $tabAria + '].' + options.tabidentify).prepend( $respTabs.find('.resp-tab-active.' + options.tabidentify+' > a').html() );
